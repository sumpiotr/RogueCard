...
public class CameraController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (freeCamera) Move();
        else transform.position = new Vector3(GameController.gameController.player.transform.position.x, GameController.gameController.player.transform.position.y, transform.position.z);
    }
    ...
    void Move() 
    {
        ...
        rigidbody2d.AddForce(new Vector2(Input.GetAxis("Horizontal") * cameraSpeed, Input.GetAxis("Vertical") * cameraSpeed));
