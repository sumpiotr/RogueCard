...
public class PlayerController : BaseCharacter
{
    ...
    {
        List<Vector2> tiles =  AStar.GetWalkableTilesInRange(transform.position, range, grid);
        ...
        foreach (Vector2 tilePosition in tiles)
        {
            ...
            {
                if (CanHit(tilePosition)) enemyTiles.Add(tileObject); 
            }
        }
