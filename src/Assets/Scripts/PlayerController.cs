...
public class PlayerController : BaseCharacter
{
    ...
    Dictionary<Card, CanvasCard> cardsGameobjects = new Dictionary<Card, CanvasCard>();
    ...
    {
        CanvasCard cardObject = cardsGameobjects[card];
    ...
    private void SetHandCardsPositions()
    {
        ...
        {
            cardsGameobjects[hand[i]].gameObject.transform.localPosition = new Vector2(0 - ((CanvasCard.WIDTH*1.5f)*2) + i * (CanvasCard.WIDTH * 1.5f), 0);
